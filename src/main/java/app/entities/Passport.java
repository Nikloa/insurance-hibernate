...
public class Passport {
    ...
    public Passport(int clientId, String firstName, String lastName, LocalDate birthDate, String passportNumber,
                        String identificationNumber, LocalDate issueDate, String issuingAuthority, boolean confirmation) {
